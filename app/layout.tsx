...
export const metadata: Metadata = {
  title: "agentRaider 3.0 — pregled rada",
  description: "Kontrolni centar agenta agentRaider 3.0",
};
    ...
    <html lang="hr">
      <body className="bg-gray-950 text-gray-100 min-h-screen">
        <nav className="bg-gray-900 border-b border-gray-800 px-4 sm:px-6 py-4 flex flex-wrap items-center gap-x-5 gap-y-3">
          <span className="font-bold text-lg text-emerald-400 w-full sm:w-auto">🤖 agentRaider <span className="text-xs text-emerald-600">3.0</span></span>
          ...
          <Link href="/decisions" className="text-gray-300 hover:text-white transition-colors">
            Odluke i dokazi
          </Link>
